...
namespace Message\App\Providers;
...
class MessageServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Message\App\Http\Controllers';
    ...
    /**
       ...
       protected function mapWebRoutes()
       {
           Route::middleware('web')
               ...
               ->group(base_path('Modules/Message/routes/web.php'));
       }
       ...
       protected function mapApiRoutes()
       {
           Route::prefix('api')
               ->middleware('api')
               ->namespace($this->namespace)
               ->group(base_path('Modules/Message/routes/api.php'));
       }
       ...
       protected function mapMobileRoutes()
       {
           Route::prefix('v1')
               ->namespace($this->namespace)
               ->group(base_path('Modules/Message/routes/mobile.php'));
       }
        /**
            * register seeders
            *
